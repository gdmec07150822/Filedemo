package com.edu.gdmec.s07150822.filedemo;
...
public class MainActivity extends AppCompatActivity {
    ...
    private File fDownlocadCacheDirectory;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fDownlocadCacheDirectory=Environment.getDownloadCacheDirectory();
    ...
    public void downloadCacheDirectory(View v){
        path=fDownlocadCacheDirectory.getAbsolutePath();
        listFiles(path);
    }
